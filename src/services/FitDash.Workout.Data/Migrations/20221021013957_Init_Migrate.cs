        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Validate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkoutRotines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkoutRotines_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "TrainingWorkoutRotine",
                columns: table => new
                {
                    TrainingsId = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkoutRotinesId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainingWorkoutRotine", x => new { x.TrainingsId, x.WorkoutRotinesId });
                    table.ForeignKey(
                        name: "FK_TrainingWorkoutRotine_Trainings_TrainingsId",
                        column: x => x.TrainingsId,
                        principalTable: "Trainings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainingWorkoutRotine_WorkoutRotines_WorkoutRotinesId",
                        column: x => x.WorkoutRotinesId,
                        principalTable: "WorkoutRotines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingWorkoutRotine_WorkoutRotinesId",
                table: "TrainingWorkoutRotine",
                column: "WorkoutRotinesId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutRotines_UserId",
                table: "WorkoutRotines",
                column: "UserId");
        }
